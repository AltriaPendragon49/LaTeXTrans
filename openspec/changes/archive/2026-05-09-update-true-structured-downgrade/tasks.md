## 1. Spec And Plan
Current status: superseded and not current. These completed tasks describe removed modern-kernel enhancement paths and are retained only as historical context.
