...
> Current status: superseded and not current. The structured downgrade behavior described here depended on removed modern-kernel paths and is historical only.
