...
Current status: superseded and not current. This plan targeted removed hard-freeze and ultimate-downgrade paths. Do not use it as an implementation guide for the current production parity kernel.
...
**Files:**
- Modify: removed ultimate-downgrade module (historical path; not present in current production code)
