## ADDED Requirements
> Current status: superseded in part by the May 9, 2026 cleanup. Current production orchestration is the parity graph only; archived modern-kernel fallback, repair, guard, and diagnostic requirements are historical context.
