## Context
Current status: partially superseded by the May 9, 2026 translation-kernel cleanup. Scheduler, token-pool, and community publishing quality-gate ideas may remain useful context, but structural fallback, downgrade, and repair-kernel ideas in this archive are not current production design.
