...
- **NEW**: `latex-translation-core` - Core LaTeX translation workflow supporting both CLI and web interfaces

**Note**: The `web-ui` spec is handled separately in the `add-web-mvp-frontend` change.
