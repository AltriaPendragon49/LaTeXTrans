...
# SUT — will live at: backend/app/services/translation/structure_checker.py
...
class TestStructureInvariantDetection:
    ...
    def test_bare_dollar_is_unsafe(self):
        ...
        # Two balanced dollars → safe; single lone dollar → unsafe
        # Note: `$5` and `$10` in text mode are bare dollars — unsafe in LaTeX
    ...
    def test_does_not_raise_on_unexpected_types(self):
        """Phase 0 must never crash — just return a safe default."""
        weird_envs = [
            {"content": None},
            {"content": 12345},
