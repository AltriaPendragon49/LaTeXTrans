          ...
          <DataTable>
            ...
            <DataTableBody>
              {terms.map((term) => {
                ...
                return (
                  <DataTableRow key={term.id} className="flex flex-col gap-2 px-4 py-3 md:grid md:grid-cols-[1fr_1fr_100px_90px_90px_100px_100px] md:items-center sm:px-6 sm:py-4">
