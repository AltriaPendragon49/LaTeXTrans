...
import { CommunitySubmitPanel } from "@/features/community-paper/components/CommunitySubmitPanel"
...
const communitySubmitStoreState = {
  config: {
    source_language: "en",
    target_language: "zh",
    advanced_config: {},
...
vi.mock("@/features/translation-workflow/store/useTranslationStore", () => ({
  useTranslationStore: (selector?: (state: typeof communitySubmitStoreState) => unknown) =>
    selector ? selector(communitySubmitStoreState) : communitySubmitStoreState,
}))
